...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "malvin~Yu1mBJyL#kHqvKZcCAyjAZdn-e2P5xu7v3YVZFlVztuN5HEtycjk",
...
// make true if want auto voice reply if someone menetion you 
     ...
     MENU_IMAGE_URL: process.env.MENU_IMAGE_URL || "https://files.catbox.moe/44tsgl.jpg",
// add custom menu and mention reply image url

       ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/44tsgl.jpg",
